...
//    [self.view addSubview:button1];
    ...
    UIButton *button2 = [[UIButton alloc] initWithFrame:CGRectMake(110, 400, 100, 50)];
    [button2 setBackgroundColor:[UIColor redColor]];
    [self.view addSubview:button2];
    [button2 setTitle:@"4" forState:UIControlStateNormal];
    [button2 addTarget:self action:@selector(buttonAction2:) forControlEvents:UIControlEventTouchUpInside];
    
    UIButton *button3 = [[UIButton alloc] initWithFrame:CGRectMake(110, 500, 100, 50)];
...
//    [self.view addSubview:button3];
    ...
    UIButton *button4 = [[UIButton alloc] initWithFrame:CGRectMake(220, 400, 100, 50)];
    ...
    UIButton *button5 = [[UIButton alloc] initWithFrame:CGRectMake(220, 500, 100, 50)];
...
//    [self.view addSubview:button5];
    ...
    UIButton *dismissButton = [[UIButton alloc] initWithFrame:CGRectMake(110, 200, 100, 50)];
